...
forward
global type w_venda from w_ancestor_compravenda
end type
end forward

global type w_venda from w_ancestor_compravenda
string title = "ERP - Venda de produtos"
end type
...
For ll_For = 1 To idw_Corrente.RowCount()
	...
	idw_Corrente.SetItem(ll_For, 'TIPOMOVIMENTO', 'V')
...
event open;call super::open;is_Tela = 'V'
end event

type tab_geral from w_ancestor_compravenda`tab_geral within w_venda
end type
